...
public class LineHolder {
    ...
    public static final Map<Pair<String,String>,LineItemDetailInfo> lineMap = new HashMap<>();

    public static final Set<String> nodeSet = new HashSet();

    static {
        lineMap.put(new Pair<String, String>("NODE21022216564500001","NODE21022309560400001"), LineItemDetailInfo.builder()
                .startNodeCode("NODE21022216564500001")
                .endNodeCode("NODE21022309560400001")
                .startNodeType("warehouse_address")
                .lineItemSequences(Arrays.asList(LineItemSequence.builder()
                        .startNodeSequence(2)
                        .endNodeSequence(3)
        ...
        lineMap.put(new Pair<String, String>("NODE21022415444800001","NODE21022216564500001"),LineItemDetailInfo.builder()
        ...
        lineMap.put(new Pair<String, String>("NODE21031614061200001","NODE21060510320100001"),LineItemDetailInfo.builder()
                ...
                .lineItemSequences(Arrays.asList(LineItemSequence.builder()
                        ...
                        .build()))
                .build());
        lineMap.put(new Pair<String, String>("NODE21031614061200001","NODE21060511104700001"),LineItemDetailInfo.builder()
                .startNodeCode("NODE21031614061200001")
                ...
                .build());
        lineMap.put(new Pair<String, String>("NODE21060510320100001","NODE21031614061200001"), LineItemDetailInfo.builder()
                ...
                .lineItemSequences(Arrays.asList(LineItemSequence.builder()
                        ...
                        .build()))
                .build());
        lineMap.put(new Pair<String, String>("NODE21060510320100001","NODE21060510340100001"),LineItemDetailInfo.builder()
                .startNodeCode("NODE21060510320100001")
        ...
        lineMap.put(new Pair<String, String>("NODE21060510340100001","NODE21060510575200001"),LineItemDetailInfo.builder()
                ...
                .build());
        lineMap.put(new Pair<String, String>("NODE21060510575200001","NODE21060510320100001"),LineItemDetailInfo.builder()
                ...
                .lineItemSequences(Arrays.asList(LineItemSequence.builder()
                        ...
                        .build()))
                .build());
        lineMap.put(new Pair<String, String>("NODE21060511104700001","NODE21060511195000001"),LineItemDetailInfo.builder()
                ...
                .build());
        lineMap.put(new Pair<String, String>("NODE21060511195000001","NODE21031614061200001"),LineItemDetailInfo.builder()
